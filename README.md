...
4. **Подберите стратегию под себя.** Точно нужную комбинацию находит **blockcheck** — авто-тестер из
   проекта zapret2 (на Windows запускается через git-bash). Это правильный способ найти рабочий вариант.
